...
# ax.plot(x, np.sin(x + 2), color="0.5", linestyle='dashdot') # -.
# ax.plot(x, np.sin(x + 3), color="#E7A747", linestyle='dotted') # :
# ax.plot(x, np.sin(x + 4), color=(1.0, 0.2, 0.3)) # RGB
# ax.plot(x, np.sin(x + 4), color='salmon')
# ax.plot(x, np.sin(x + 4), '--g')
...
# plt.scatter(iris.frame['sepal length (cm)'],
#             iris.frame['sepal width (cm)'],
#             s = 100 * iris.frame['sepal length (cm)'],
#             c=iris.frame['target'],
#             alpha = 0.3)
...
# графики плотности и контурные графики (на 2D изобразить 3D)
...
# cnt = plt.contour(X, Y, Z, 10, cmap='RdGy')
